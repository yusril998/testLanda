...
?>
<h4>Daftar Sekolah Di Malang</h4>
...
for ($i=0; $i < count($list) ; $i++) { 
    ...
    foreach ($data as $key => $value) {
        if ( strstr( $key, $parm ) ) {
?>
Nama Sekolah : <b><?=$key?></b><br>
Alamat Sekolah : <b><?=$value['alamat']?></b><br>
Telepon Sekolah : <b><?=$value['tlp']?></b><br>

<table border="1">
<tr>
<th>NIS</th>
<th>Nama</th>
<th>Tanggal Lahir</th></tr>
<tr>
<?php 
if (isset($value['siswa'])) {
    foreach ($value['siswa'] as $value2) {
        echo '<tr><th>'.$value2['nis'].'</th>
        <th>'.$value2['nama'].'</th>
        <th>'.$value2['tgl_lahir'].'</th></tr>';
    }
   echo '<table><br><hr>';
}else{

?>
<td colspan="4">Tidak ada siswa</td></tr><table><br><hr>
